package com.anushka.androidtutz.contactmanagerrx;
...
import com.anushka.androidtutz.contactmanagerrx.adapter.ContactsAdapter;
import com.anushka.androidtutz.contactmanagerrx.db.ContactsAppDatabase;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(" Contacts Manager Rx");

        recyclerView = findViewById(R.id.recycler_view_contacts);

        //all db operations are happening in background thread using rxjava
        contactsAppDatabase = Room.databaseBuilder(getApplicationContext(), ContactsAppDatabase.class, "ContactDBRx").build();
